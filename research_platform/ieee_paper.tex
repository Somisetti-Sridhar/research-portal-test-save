...
\author{%
\IEEEauthorblockN{Dr Sheela J}
\IEEEauthorblockA{\small Assistant Professor Sr. Grade 2\\
\small SCOPE\\
...
\noindent A simplified view of the repository hierarchy used in this work:
\begin{lstlisting}
research_platform/
├─ manage.py
├─ requirements.txt
├─ research_platform/            # project settings, URLs, ASGI/WSGI, Celery
│  ├─ settings.py
│  ├─ urls.py
│  ├─ asgi.py
│  └─ celery.py
...
│  ├─ papers/                    # models, views, upload, approval, bookmarks, ratings
│  ├─ search/                    # search views, history, suggestions
│  ├─ chat/                      # channels consumers, views, utils (moderation)
│  ├─ groups/                    # group models and views
│  └─ ml_engine/                 # recs engine, embeddings, models
├─ templates/                    # Django templates for all modules
├─ static/                       # CSS/JS
├─ media/                        # uploaded PDFs, avatars
├─ logs/                         # application logs
└─ ml_models/                    # summarizer utilities and model artifacts
\end{lstlisting}
